...
//getters and setters----------------------------------------------
    ...
    public NodoR getpFirst() {return pFirst;}
    
    public void setpFirst(NodoR pFirst) {this.pFirst = pFirst;}

    public NodoR getpLast() {return pLast;}

    public void setpLast(NodoR pLast) {this.pLast = pLast;}
