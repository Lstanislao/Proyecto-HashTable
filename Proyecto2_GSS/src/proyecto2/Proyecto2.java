...
public class Proyecto2 {
    ...
    public static void main(String[] args) {
        ...
        for (String p : arregloPalabrasClaves) {
            PalabrasClaves.InsertarInicio(p);
        }

        PalabrasClaves.InsertarInicio("hola");
        PalabrasClaves.InsertarInicio("ayuda");
        PalabrasClaves.InsertarInicio("no");
        PalabrasClaves.InsertarInicio("quiero");
        PalabrasClaves.InsertarInicio("estudiar");
        PalabrasClaves.InsertarInicio("base");
        PalabrasClaves.InsertarInicio("estructura");
        ...
        for (String a : arregloPalabrasClaves1) {
